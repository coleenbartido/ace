...
INSERT INTO `admin_account` VALUES ('201401171@iacademy.edu.ph',2),('201402225@iacademy.edu.ph',2);
...
INSERT INTO `college_student` VALUES ('2014-02225',2,3,1,1),('2014-02226',2,2,1,1),('2014-02227',5,4,1,1);
...
--
-- Table structure for table `current_report_info`
--

DROP TABLE IF EXISTS `current_report_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `current_report_info` (
...
--
-- Dumping data for table `current_report_info`
--

LOCK TABLES `current_report_info` WRITE;
/*!40000 ALTER TABLE `current_report_info` DISABLE KEYS */;
INSERT INTO `current_report_info` VALUES (NULL,1,NULL),('2016 - 2017',2,3);
/*!40000 ALTER TABLE `current_report_info` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `faculty_account` VALUES ('201401171@iacademy.edu.ph',0),('201403242@iacademy.edu.ph',3);
...
INSERT INTO `message` VALUES (4,12,'201402225@iacademy.edu.ph','201403242@iacademy.edu.ph','Referral for Jhaya Valenciano: MOBCOM','hello','2017-06-07 10:34:59',0,1,1,1),(5,12,'201402225@iacademy.edu.ph','201403242@iacademy.edu.ph','Referral for Jhaya Valenciano: MOBCOM','yo','2017-06-07 10:35:27',0,1,1,1);
...
INSERT INTO `reason` VALUES (14,10,1),(15,10,2),(16,11,2),(17,11,3),(18,12,3),(19,12,4),(20,12,5);
...
INSERT INTO `report` VALUES (10,'201403242@iacademy.edu.ph','2014-02225',2,1,'2017-06-07 10:30:48','ENT JAVA',3,'2016 - 2017',NULL,NULL,0,0,1),(11,'201403242@iacademy.edu.ph','2014-02226',2,1,'2017-06-07 10:32:41','PHP',3,'2016 - 2017',NULL,NULL,0,0,1),(12,'201403242@iacademy.edu.ph','2014-02227',2,1,'2017-06-07 10:34:06','MOBCOM',3,'2016 - 2017',NULL,'hello',1,0,1);
...
INSERT INTO `student` VALUES ('2014-02225',2,'Paul','Jao'),('2014-02226',2,'Bea','Madjus'),('2014-02227',2,'Jhaya','Valenciano');
...
INSERT INTO `superadmin_account` VALUES ('johnbryan.ferraro@iacademy.edu.ph',1,'$2y$10$jIGrhp3IHFOeQrxWZj1NvuLPjJsjUeqqn3pOnuFAazBWbh2biNZ7O',NULL,NULL);
...
INSERT INTO `user` VALUES ('201401171@iacademy.edu.ph',3,'sdfsfd','fsdfsfs',NULL,NULL,NULL,0,NULL),('201402225@iacademy.edu.ph',2,'Paul','Jao',NULL,'$2y$10$vhDRSJyRkl9B4.yByZh0jO7y1t0pNxGOrqnQZbC4Wbg2F3HEFgVqy',NULL,1,NULL),('201403242@iacademy.edu.ph',3,'Jhaya','Valenciano',NULL,'$2y$10$MZhKIQKmu9D.jYYg3Tjb9O04NTa1NVb3BBgvz98EOkb5Dw/LU1jCK',NULL,1,NULL);
...
-- Dump completed on 2017-06-07 19:28:17
